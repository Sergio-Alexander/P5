...
{
	public class infantrySkipQuirkyGuard : Infantry, IGuard
    {
        ...
        public infantrySkipQuirkyGuard(int[] arti, int armament_strength, int attack_range, int fighter_row, int fighter_col, int[] skip_quirky_array, int k) : base(arti, armament_strength, attack_range, fighter_row, fighter_col)
		{
